...
| ◐ | 21 Aug | Dev-dev | Foundation | `F4` **Model & hook conventions** — extend the integration standard; scaffold script; scope-aware query-key helper | L | 3 | Land before others write API files. |
