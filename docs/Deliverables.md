...
| ◐ | 25 Aug | Dev - RS | RBAC | `A14` **Effective-permission preview** — pick a user and a scope; see what they can do and *which grant said so* | H | 4 | Provenance is the feature. |
